...
- [x] Install calendar APIs: `npm install googleapis @microsoft/microsoft-graph-client`
- [x] Register OAuth apps (Google Cloud Console + Azure AD)
- [x] Add calendar columns to users table
- [x] Implement OAuth routes and callback handlers
- [x] Implement calendarService with Google + Outlook methods
- [x] Integrate with booking/reschedule/cancel APIs
- [x] Create CalendarSyncModal frontend component
